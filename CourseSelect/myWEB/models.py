...
class ClassTable(models.Model):  # 开课表
    ...
    kcrl = models.IntegerField(blank=False, default=0)
    syrl = models.IntegerField(blank=False, default=0)
...
class AssessTable(models.Model):  # 评教表
    cid = models.ForeignKey(ClassTable, on_delete=models.CASCADE)
